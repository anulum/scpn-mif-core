...
|---|---:|---:|---|
| `derivatives_2` | Rust | 510 ns | fastest |
| `derivatives_2` | Python | 16.30 us | 32.0x slower than Rust |
| `trace_120` | Rust | 125.97 us | fastest |
| `trace_120` | Python | 23.94 ms | 190.0x slower than Rust |
| `trace_120` | Julia CLI | 2.13 s | CLI startup comparison |
