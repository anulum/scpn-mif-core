...
## Cited by the software-paper review package (`papers/submissions/001_formally_verified_deterministic_trigger_interlock/`)
...
| Govorkova et al. (2026) | Enabling Low-Latency Machine Learning on Radiation-Hard FPGAs with hls4ml. arXiv:2602.15751 | https://arxiv.org/abs/2602.15751 | Comparative context (synthesis-indicated 25 ns latency on a PolarFire target) | 2026-08-27 (arXiv record and abstract re-read at source) | arXiv non-exclusive — local-only `pdfs/arXiv_2602.15751.pdf` (gitignored) |
...
| Moffett & Chesny (2026) | Solid-state switch arrays for digitized plasma control and magneto-inertial fusion applications. US Patent 12,567,738 B1, assignee Equilibria Power | https://patents.google.com/patent/US12567738B1/en | Prior-art context for the chamber-side trigger lane; public boundary note in `docs/papers/us12567738b1.md` | 2026-06-26 (assignee + title + inventors + issue date re-read at source) | US patent — public domain; **committed** `US12567738B1.pdf` (37 pp, USPTO scan) |
...
- Keep this register in sync with the canonical package's `references.bib`.
