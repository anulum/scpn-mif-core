...
struct DopplerKuramotoSpec
    ...
    function DopplerKuramotoSpec(
        ...
        new(omega, coupling, alpha, gamma, epsilon, distance_scale)
    end
end
...
function step!(engine::DopplerKuramoto, dt_s::Real)::DopplerKuramotoState
    ...
    k1 = doppler_derivatives(engine.spec, engine.phases_rad, engine.positions_m, velocities)
