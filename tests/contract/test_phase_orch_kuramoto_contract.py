...
def test_scpn_phase_orchestrator_module_importable(scpn_phase_orchestrator) -> None:  # noqa: ANN001
    assert scpn_phase_orchestrator is not None


def test_scpn_phase_orchestrator_version_pin(scpn_phase_orchestrator) -> None:  # noqa: ANN001
    expected = "0.6.5"
    ...
    assert actual == expected, (
        f"scpn-phase-orchestrator pin drift: contract expects {expected}, installed {actual}"
    )
